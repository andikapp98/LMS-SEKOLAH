    ...
    <AppLayout :user="$page.props.auth.user">
        <template #header>
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                ...
                <Link :href="route('teachers.index')" class="text-sm text-blue-600 hover:text-blue-800">
        ...
        <div class="space-y-4 sm:space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-4 sm:px-6 py-3 sm:py-4">
                    ...
                    <p class="text-xs sm:text-sm text-blue-100 mt-1">Import data guru dari file Excel (.xlsx, .xls) atau CSV</p>
                </div>
                ...
                <div class="p-4 sm:p-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <ul class="text-xs sm:text-sm text-blue-800 space-y-1 list-disc list-inside">
                                    ...
                                    <li><strong>Kolom A-N:</strong> Nama | NIK | NUPTK | Tempat Lahir | Tanggal Lahir | Jenis Kelamin | Agama | Alamat | Status Pernikahan | Telepon | Status | Email | Lembaga | <span class="text-orange-600 font-bold">Kode Guru</span></li>
                                    <li>Format file: <strong>.xls, .xlsx, atau .csv</strong></li>
                                    <li>Maksimal ukuran: 5 MB</li>
                                    <li>Data dengan Kode Guru atau NIK sama akan di-update</li>
                                    <li class="text-orange-600 font-semibold">⭐ Kolom Kode Guru (N) sangat penting untuk mapping dengan mata pelajaran!</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 text-sm">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Pendidikan</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-gray-700">Ahmad Santoso</td>
                                        <td class="px-4 py-3 text-gray-700">ahmad@sekolah.com</td>
                                        <td class="px-4 py-3 text-gray-700">081234567890</td>
                                        <td class="px-4 py-3 text-gray-700">Matematika</td>
                                        <td class="px-4 py-3 text-gray-700">S1 Pendidikan</td>
                                        <td class="px-4 py-3 text-gray-700">Jl. Merdeka</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <form @submit.prevent="submitUpload" class="space-y-4 sm:space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-4 border-t border-gray-200">
                            <Link :href="route('teachers.index')" class="text-sm text-center sm:text-left text-gray-600 hover:text-gray-800">
                                ← Kembali
                            </Link>
                            <button
                                type="submit"
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <ul class="text-xs sm:text-sm text-yellow-800 space-y-1">
                            ...
                            <li>• NIP sama akan di-update</li>
                            <li>• Kolom Nama wajib diisi</li>
                            <li>• Email boleh dikosongkan</li>
                        </ul>
                    </div>
                </div>
            </div>
