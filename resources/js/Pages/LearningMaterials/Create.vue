        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">Informasi Materi</h3>
                </div>
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Contoh: Modul Pemrograman Dasar Bab 1"
                        />
                    ...
                    <div v-else>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6">
                            ...
                            <div v-if="!form.file" class="text-center">
                                ...
                                <p class="mt-2 text-xs text-gray-500">Maksimal 50MB</p>
                            </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t">
                        ...
                        >
                            <span v-if="processing">Mengupload...</span>
                            <span v-else>Upload Materi</span>
                        </button>
                    </div>
                </form>
            </div>
...
const submit = () => {
    ...
    router.post('/learning-media', formData, {
        preserveScroll: true,
        onSuccess: () => {
